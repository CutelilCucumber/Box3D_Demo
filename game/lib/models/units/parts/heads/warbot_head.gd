...
## Warbot head part for the modular mech. Exposes the two weapon muzzle markers
## (main gun + reclaim laser). The head root is the aiming pivot: mech_body.gd
## rotates the whole head around the body's mount point.
